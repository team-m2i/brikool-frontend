         ...
         <header id="header" className="pt-32">
                ...
                <div className="section1 px-4 sm:px-6 lg:px-8 flex flex-col-reverse lg:flex-row z-50 justify-evenly items-center space-y-10 lg:space-y-0">
                    <div className="text-center lg:text-left">
                        ...
                        {entryTitle.map((item) => (
                            <h1 key={item.name} className="text-2xl sm:text-4xl lg:text-7xl pb-1">
                                {item.name}
                            </h1>
                        ))}
                        <div className="mt-4 space-y-2">
                            <p className="text-sm sm:text-base">{t('entrytitle.subtitle1')}</p>
                            <p className="text-sm sm:text-base">{t('entrytitle.subtitle2')}</p>
                        </div>
                        <div className="pt-4">
                    ...
                    <div className="hidden lg:flex carousel justify-center items-center h-full w-full lg:w-auto">
                        ...
                        >
                            <CarouselContent className="h-[300px] sm:h-[400px] lg:h-[500px]">
                                <CarouselItem ><img src="/assets/images/heroSlide1.svg" alt="heroSlide1" className="w-full h-full object-contain" /></CarouselItem>
                                <CarouselItem >
                                    <div className="relative w-full lg:w-[520px] h-[300px] sm:h-[400px] lg:h-[520px] flex justify-center items-center text-lg sm:text-xl lg:text-[30px]">
                                        ...
                                        <img className="absolute top-20 lg:top-[150px] right-1/4" src="/assets/images/hammer.svg" alt="hammerSvg" />
                                        <img className="absolute bottom-20 lg:bottom-[150px] left-1/4" src="/assets/images/fingerprint.svg" alt="fingerPrintSvg" />
                                    </div>
                                </CarouselItem>
                                <CarouselItem >
                                    <div className="relative w-full lg:w-[520px] h-[300px] sm:h-[400px] lg:h-[520px] flex justify-center items-center text-base sm:text-lg lg:text-[25px]">
                                        ...
                                        <img className="absolute top-5 sm:top-[20px] right-[60px] sm:right-[120px]" src="/assets/images/heroTopImg.svg" alt="heroTopImg" />
                                        <img className="absolute top-[200px] sm:top-[290px] left-[10px]" src="/assets/images/heroLeftImg.svg" alt="heroLeftImg" />
                                        <img className="absolute top-[180px] sm:top-[270px] right-[30px] sm:right-[50px]" src="/assets/images/heroRightImg.svg" alt="heroRightImg" />
                                    </div></CarouselItem>
                            </CarouselContent>
                        </Carousel>
                    </div>
