...
const ProfileBox: React.FC<ProfileBoxProps> = ({ freelancer }) => {
            ...
            <div className="mt-4">
              ...
              <div className="mx-auto mb-5.5 mt-5 grid max-w-[600px] grid-cols-3 rounded-[5px] border border-stroke py-[9px] shadow-1 dark:border-dark-3 dark:bg-dark-2 dark:shadow-card">
                ...
                <div className="flex flex-col items-center justify-center gap-1 px-4 xsm:flex-row">
                  ...
                  <span className="font-medium text-dark dark:text-white">
                  {freelancer.region || "Region"} : {freelancer.city || "City"}
                </span>
                </div>
              </div>
              ...
              <div className="mx-auto max-w-[720px]">
                ...
                <p className="mt-4">{freelancer.description || "Description utilisateur"}</p>
              </div>
